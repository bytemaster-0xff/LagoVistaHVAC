...
$(BINARYDIR)/system_stm32f4xx.o : $(BSP_ROOT)/STM32F4xxxx/CMSIS/Device/ST/STM32F4xx/Source/Templates/system_stm32f4xx.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/startup_stm32f40xx.o : $(BSP_ROOT)/STM32F4xxxx/Startup/startup_stm32f40xx.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
